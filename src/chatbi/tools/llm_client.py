...
class LLMClient:
    ...
    def update_config(self, model: str = None, temperature: float = None, max_tokens: int = None):
        """
        更新LLM配置
    ...
    async def astream_with_prompt(self, prompt_template: str, **kwargs) -> AsyncGenerator[str, None]:
        """
        使用提示词模板流式异步调用LLM
    ...
    async def astream_with_system(self, system_prompt: str, user_prompt: str) -> AsyncGenerator[str, None]:
        """
