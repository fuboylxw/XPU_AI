...
.new-chat-btn:hover { box-shadow: 0 4px 14px rgba(74, 144, 226, 0.35); }

.new-chat-btn:hover::before { display: none; }

.new-chat-btn:active { box-shadow: 0 2px 8px rgba(74, 144, 226, 0.25); }
